...
Page {
        ...
        Container {
            ...
            StandardListItem {
                ...
                gestureHandlers: [
                    TapHandler {
                        onTapped: {
                            appSettings.invertedTheme = !appSettings.invertedTheme;
            ...
            Container {
                ...
                ToggleButton {
                    checked: appSettings.invertedTheme
                    ...
                    onCheckedChanged: {
                        appSettings.invertedTheme = checked;
                    }
                }
            }
        }
    ...
    attachedObjects: [
        Settings {
            ...
            property bool invertedTheme
        }
    ]

    onCreationCompleted: {
        appSettings.invertedTheme
