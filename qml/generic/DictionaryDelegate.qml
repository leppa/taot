...
//    width: ListView.view.width
    ...
    Layout.preferredHeight: posDelegate.height + indicator.height / 2
...
//                font.pixelSize: UI.LIST_TILE_SIZE
        ...
        Column {
            ...
            TableView {
                ...
                TableViewColumn {
                    title: qsTr("Reverse translations")
                    role: "translations"
                }
            }
...
//                                  : "#191919" /*UI.COLOR_FOREGROUND*/
    ...
    Image {
        ...
        sourceSize {
            width: 16 /*Layout.spacing*/
            height: 16 /*Layout.spacing*/
        }
        anchors {
            top: posDelegate.bottom
            topMargin: -sourceSize.height / 4 + 1
            right: parent.right
        }
    }
}
